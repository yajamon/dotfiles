...
if [ -z $SRC_FILE ]
  ...
  convert "$SRC_FILE" -resize 20x20     "$DST_PATH/Icon-Small-20.png"
  ...
  convert "$SRC_FILE" -resize 87x87     "$DST_PATH/Icon-Small-29@3x.png"
  ...
  convert "$SRC_FILE" -resize 512x512   "$DST_PATH/iTunesArtwork-512.png"
  convert "$SRC_FILE" -resize 1024x1024 "$DST_PATH/iTunesArtwork-512@2x.png"
fi
